...
The `clinTrialData` package provides access to clinical trial example datasets in R. Data is stored in Parquet format and accessed through the `connector` package.

## Features

- Multiple clinical trial data sources (CDISC Pilot 01 and extended datasets)
...
Standard CDISC Pilot 01 datasets (10 ADaM, 22 SDTM) for quick testing and examples.

### cdisc_pilot_extended

Enhanced CDISC Pilot 01 datasets (11 ADaM, 24 SDTM) with additional features:
...
Datasets are stored in Apache Parquet format for efficient storage and fast access.
