...
The `ctdata` package provides access to clinical trial example datasets in R. Data is stored in Parquet format and accessed through the `connector` package.
