...
- [ ] **`piggyback` in Suggests vs Imports**: Promoting to Imports would
  make `list_available_studies()` work out of the box, but Suggests is
  correct per R conventions. The offline fallback now softens first-use UX.
